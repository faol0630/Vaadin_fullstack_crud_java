...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        H1 appName = new H1("Client's crud");
    ...
    private SideNav createNavigation() {
        ...
        nav.addItem(new SideNavItem("NewClient", NewClientView.class, LineAwesomeIcon.USER.create()));
        nav.addItem(new SideNavItem("SearchByLastname", SearchByLastname.class, LineAwesomeIcon.USER.create()));
